...
#define sparse_pop_count(x) pop_count(x)
#define bsf(x) (Square) _BitScanForward64(x)
#else
#define pop_count(x) __builtin_popcountll(x)
#define sparse_pop_count(x) __builtin_popcountll(x)
#define bsf(x) (Square) __builtin_ctzll(x)
#endif
